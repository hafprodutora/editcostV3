...
import { LayoutDashboard, PlusCircle, Settings, LogOut, Coins, User, CalendarDays } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="bg-white border-t border-gray-200 py-4 no-print">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-400 text-xs font-medium">
